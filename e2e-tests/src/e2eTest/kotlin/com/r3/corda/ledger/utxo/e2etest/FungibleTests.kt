...
class FungibleTests {
    ...
    private companion object {
        const val TEST_CPI_NAME = "ledger-utxo-advanced-fungible-demo-app"
        const val TEST_CPB_LOCATION = "/META-INF/ledger-utxo-advanced-fungible-demo-app.cpb"
    ...
    fun `Alice issues a token to Bob, Bob then transfers to Charlie, and then Bob burns some quantity of their token`() {
        ...
        val mintTokenFlowRequestId = startRpcFlow(
            ...
            "net.cordapp.demo.utxo.fungible.workflow.mint.MintTokenFlow\$Initiator"
        )
        ...
        val moveTokenFlowRequestId = startRpcFlow(
            ...
            "net.cordapp.demo.utxo.fungible.workflow.move.MoveTokenFlow\$Initiator"
        )
        ...
        val burnTokenFlowRequestId = startRpcFlow(
            ...
            "net.cordapp.demo.utxo.fungible.workflow.burn.BurnTokenFlow\$Initiator"
        )
