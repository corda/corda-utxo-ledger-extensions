...
public final class FungibleConstraints {
     ...
     * @param type        The {@link FungibleState} type to verify.
     * @param <T>         The underlying {@link FungibleState} type to verify.
     ...
     * @param <T>    The underlying {@link FungibleState} type to filter.
